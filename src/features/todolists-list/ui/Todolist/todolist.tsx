...
import { FilterValuesType, TodolistDomainType, todolistThunks, todolistsActions, todolistsReducer } from '../../todolists/todolists-reducer'
...
export const Todolist = React.memo(function ({ demo = false, ...props }: PropsType) {
    ...
    const onAllClickHandler = useCallback(() => dispatch(todolistsActions.changeTodolistFilter({ filter: 'all', id: props.todolist.id })), [props.todolist.id])
    const onActiveClickHandler = useCallback(() => dispatch(todolistsActions.changeTodolistFilter({ filter: 'active', id: props.todolist.id })), [props.todolist.id])
    const onCompletedClickHandler = useCallback(() => dispatch(todolistsActions.changeTodolistFilter({ filter: 'completed', id: props.todolist.id })), [props.todolist.id])
